            ...
            <div class="ml-4 flex items-center md:ml-6">
              ...
              <Menu as="div" class="ml-3 relative">
                ...
                <transition enter-active-class="transition ease-out duration-100"
                  ...
                  <MenuItems
                      class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 cursor-pointer ring-black ring-opacity-5 focus:outline-none">
                    <MenuItem v-slot="{ active }">
                      <a
                          @click="logOut()"
                          :class="['block px-4 py-2 text-sm text-gray-700']">Sign Out
                      </a>
                    </MenuItem>
                  </MenuItems>
                </transition>
